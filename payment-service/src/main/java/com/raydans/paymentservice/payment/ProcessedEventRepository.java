...
public interface ProcessedEventRepository extends JpaRepository<ProcessedEventEntity, UUID> {
     ...
     * transaction the caller provides: the claim, the payment row, and the outbox row
     * therefore commit or roll back together. Returns 1 when this transaction took the
     * claim, or 0 when the event was already claimed (by a previous or a concurrent
